...
public class CourseTest {
	...
	public void testCourseStringStringStringIntStringStringIntInt() {
		...
		c = null;
		try {
			c = new Course(NAME, null, SECTION, CREDITS, INSTRUCTOR_ID, MEETING_DAYS, START_TIME, END_TIME);
			fail();
		} catch (IllegalArgumentException e) {
			assertNull(c);
		}
		...
		c = null;
		try {
			c = new Course(NAME, TITLE, null, CREDITS, INSTRUCTOR_ID, MEETING_DAYS, START_TIME, END_TIME);
			fail();
		} catch (IllegalArgumentException e) {
			assertNull(c);
		}
		...
		c = null;
		try {
			c = new Course(NAME, TITLE, SECTION, CREDITS, null, MEETING_DAYS, START_TIME, END_TIME);
			fail();
		} catch (IllegalArgumentException e) {
			assertNull(c);
		}
		...
		c = null;
		try {
			c = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, null, START_TIME, END_TIME);
			fail();
		} catch (IllegalArgumentException e) {
			assertNull(c);
		}
		...
		c = null;
		try {
			c = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, MEETING_DAYS, 2401, END_TIME);
			fail();
		} catch (IllegalArgumentException e) {
			assertNull(c);
		}
		...
		c = null;
		try {
			c = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, MEETING_DAYS, START_TIME, START_TIME - 1);
			fail();
		} catch (IllegalArgumentException e) {
			assertNull(c);
		}
		...
		c = null;
		try {
			c = new Course(NAME, TITLE, SECTION, 19, INSTRUCTOR_ID, MEETING_DAYS, START_TIME, END_TIME);
			fail();
		} catch (IllegalArgumentException e) {
			assertNull(c);
		}
		...
		c = null;
		try {
			c = new Course(NAME, TITLE, SECTION, -1, INSTRUCTOR_ID, MEETING_DAYS, START_TIME, END_TIME);
			fail();
		} catch (IllegalArgumentException e) {
			assertNull(c);
		}
